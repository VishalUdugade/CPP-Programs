...
int main()
{
	...
	unsigned long long int i_arr[size] = {1,2,3,4,5,6};
	long double d_arr[size] = {33.44,34.553,76.433,3.353,99.303,22.453};
    ...
    Sum<unsigned long long int>(i_arr,size,"Multiplication of Integer array = ");
    
    Sum<long double>(d_arr,size,"Sum of Float array = ");
